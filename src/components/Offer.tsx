              ...
              <div className="offer__host">
                ...
                <div className="offer__description">
                  <p className="offer__text">
                    A quiet cozy and picturesque that hides behind a river by the unique lightness of
                  ...
                  <li className="reviews__item">
                    ...
                    <div className="reviews__info">
                      ...
                      <p className="reviews__text">
                        A quiet cozy and picturesque that hides behind a river by the unique lightness
